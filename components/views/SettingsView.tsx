                    ...
                    <div className="flex flex-col gap-3 mb-4">
                      <div className="p-3 bg-primary/5 rounded-xl border border-primary/10">
                        <h5 className="text-xs font-bold text-primary flex items-center gap-2">
                          <Sparkles size={14} /> Configuração Final do CRM:
                        </h5>
                        <p className="text-[10px] text-on-surface-variant mt-1">
                          Como você é a dona do sistema, precisa preparar seu banco de dados uma única vez para que tudo funcione. 
                          Clique no botão abaixo e cole o código no <b>SQL Editor</b> do seu Supabase.
                        </p>
                      </div>
                      <button 
                        onClick={() => {
...
-- DESATIVE RLS PARA TESTES INICIAIS
ALTER TABLE profiles DISABLE ROW LEVEL SECURITY;
ALTER TABLE clients DISABLE ROW LEVEL SECURITY;
ALTER TABLE appointments DISABLE ROW LEVEL SECURITY;
`;
                          navigator.clipboard.writeText(sql.trim());
                          alert('✅ SCRIPT COPIADO!\n\nAgora vamos configurar o Supabase. \n1. Clique em "New Query"\n2. Cole o código (Ctrl+V)\n3. Clique em "Run"');
                      ...
                      >
                        COPIAR SCRIPT E CONFIGURAR BANCO
                      </button>
                    </div>

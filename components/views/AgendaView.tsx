                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-3">
                        <div className="relative w-8 h-8 rounded-full overflow-hidden bg-slate-200">
                          <Image src={client?.img || `https://api.dicebear.com/7.x/avataaars/svg?seed=${app.client_name}&gender=female`} alt={app.client_name} fill className="object-cover" referrerPolicy="no-referrer" />
                        </div>
                        <div>
